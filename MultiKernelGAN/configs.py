...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument('--weights_dir_path', default=os.path.dirname(__file__) + '/weights', help='weights path')
        self.parser.add_argument('--masks_dir_path', default=os.path.dirname(__file__) + '/masks', help='masks path')
